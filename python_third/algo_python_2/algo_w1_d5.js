...
console.log(invertObj(two_obj1), "expected: ", two_expected1);
console.log(invertObj(two_obj2), "expected: ", two_expected2);
console.log(invertObj(two_obj3), "expected: ", two_expected3);
